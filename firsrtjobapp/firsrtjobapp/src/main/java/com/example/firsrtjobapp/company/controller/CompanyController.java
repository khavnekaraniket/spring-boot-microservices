package com.example.firsrtjobapp.company.controller;
...
public class CompanyController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<String> getCompanyById(@PathVariable("id") Long id) {
        Company company = companyService.getCompanyById(id);
        System.out.println(company);
        if (company != null) {
            return ResponseEntity.ok("Company found: " + company.getName());
        } else {
